...
<p align="center">
  <strong>An autonomous trading intelligence that never sleeps.</strong><br/>
...
<p align="center">
  ...
  <img alt="Paper Trading" src="https://img.shields.io/badge/Paper_Trading-Only-0EA5E9?style=flat-square"/>
  <img alt="Alpaca" src="https://img.shields.io/badge/Powered_by-Alpaca-FF6B35?style=flat-square"/>
  <img alt="Options" src="https://img.shields.io/badge/Options-Defined_Risk-8B5CF6?style=flat-square"/>
  <img alt="Hackathon" src="https://img.shields.io/badge/Hackathon-Aug_28_—_Sep_4_2026-111827?style=flat-square"/>
</p>
...
<p align="center">
  <strong>🎬 Video Walkthrough</strong> — <code>docs/demo/mandate-demo.mp4</code><br/>
...
```mermaid
flowchart TB
    Alpaca{{Alpaca — Paper Trading Authority}}

    Scout[Market Scout<br/>IPO & Discovery]
    News[News Gate<br/>Signal vs Noise]
    Signals[Signal Ensemble<br/>7 lenses → One Score]
    Risk[Risk Manager<br/>Stops · Targets · Flatten]
    ...
    Dashboard([Live Dashboard<br/>Equity · Positions · Timeline · IPO Stream])
    ...
    style Alpaca fill:#FF6B35,stroke:#111827,color:#fff
    style Trader fill:#0EA5E9,stroke:#111827,color:#fff
...
<p align="center">
  <em>Built with discipline. Traded on paper. Judged on equity.</em><br/>
