...
| [#2](https://github.com/GoatWhistle/harness-hack/pull/2) | M12 — AI universe + portfolio-aware funnel | Qodo на commit `993061d`: **Bugs 0, Rule violations 0, Skill insights 0** | Universe расширен до 18 публичных AI/platform/infrastructure акций + SPY; добавлены RSI/MACD/vol-adjusted momentum, feature factory, bounded 8-symbol funnel, correlation-cluster sizing, PARK counterfactual outcomes и 24h pre-LLM cutoff. Full MCP E2E обработал 19 символов, TrueForge E2E `01m13mvc90zx3qg4tr6nxd4sb9` вызвал только два read-only tool | Нет |
