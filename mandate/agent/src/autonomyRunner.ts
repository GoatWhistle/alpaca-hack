...
export function buildHypothesisPrompt(
  ...
  return [
    ...
    "Always compare executable LONG and SHORT candidates. In risk_off, make the strongest validated canonical SHORT an explicit hypothesis instead of defaulting to LONG-only analysis.",
